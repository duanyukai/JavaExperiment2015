...
public class GourmetCoffee  {
	...
	public void displayNumberOfOrders(Product product) {
        ...
        int sum = 0;
        for(Order o : this.sales){
            for(OrderItem i : o){
                if(i.getProduct().equals(product))
                    sum++;
            }
        }
        System.out.println("Number of orders that contains the product " + product.getCode() + ": " + sum);
...
//        for(Order o : this.sales){
//            for(OrderItem i :o){
//                if(!(products.containsKey(i.getProduct())))
//                    products.put(i.getProduct(),i.getQuantity());
//                else
//                    products.put(i.getProduct(),products.get(i.getProduct()) + i.getQuantity());
//            }
//        }
        for(Order o : this.sales){
            for(OrderItem i :o){
        ...
        for(Product s : products.keySet()){
            System.out.println(s.getCode() + " " + products.get(s));
        }
	}
